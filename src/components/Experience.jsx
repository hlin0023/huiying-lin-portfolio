...
const previewExperience = [
  {
    company: 'Blackhall & Pearl',
    role: 'Software Engineer (Part-time)',
    detail: 'Full-stack React, TypeScript, GraphQL, and production web app work.',
  },
  {
    company: 'Adica Insurance',
    role: 'Data Engineer',
    detail: 'Data pipelines, analytics support, and data quality workflows.',
  },
  {
    company: 'TikTok Ltd.',
    role: 'Back-end Developer Intern',
    detail: 'Go services, SQL, and internal platform work in a cloud environment.',
  },
];

const Experience = ({ isExpanded, onToggle }) => {
  return (
        ...
        <>
          <div className="key-points-grid">
            {previewExperience.map((experience) => (
              <article className="key-point-card" key={`${experience.company}-${experience.role}`}>
                <h3>{experience.company}</h3>
                <p className="card-subtitle">{experience.role}</p>
